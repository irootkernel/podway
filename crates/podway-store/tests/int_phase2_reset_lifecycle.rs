...
fn assert_exact_published_reset_target(
    ...
    assert_eq!(
        ...
        vec![
            ...
            ("blockers".to_owned(), 0),
            ("v2_workspace_state".to_owned(), 0),
            ("v2_procedure_snapshots".to_owned(), 0),
            ("v2_graph_nodes".to_owned(), 0),
            ("v2_task_sessions".to_owned(), 0),
            ("v2_graph_node_counters".to_owned(), 0),
            ("v2_attempts".to_owned(), 0),
            ("v2_item_slots".to_owned(), 0),
            ("v2_blockers".to_owned(), 0),
            ("v2_resolved_evidence_references".to_owned(), 0),
            ("v2_decision_records".to_owned(), 0),
            ("v2_rework_records".to_owned(), 0),
            ("v2_goal_revisions".to_owned(), 0),
            ("v2_goal_criteria".to_owned(), 0),
            ("v2_criterion_assessment_results".to_owned(), 0),
            ("v2_criterion_citations".to_owned(), 0),
            ("v2_goal_assessments".to_owned(), 0),
        ]
    );
    assert_eq!(
        snapshot.job,
