...
use podway_core::{
    ...
    EvidenceFromListV2, GraphPlacementV2, TransitionEffectV2,
};
...
fn definition_path(id: &str) -> FieldPath {
    FieldPath::root()
        .child_key("node_definitions")
        .child_key(id)
}

fn node_path(index: usize) -> FieldPath {
    FieldPath::root()
        .child_key("graph")
        .child_key("nodes")
        .child_index(index)
...
fn placement_definition_id(placement: &GraphPlacementV2) -> &str {
    match placement {
...
fn placement_evidence_from(placement: &GraphPlacementV2) -> Option<&EvidenceFromListV2> {
    match placement {
