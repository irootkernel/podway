...
impl DomainCommand {
    pub const fn kind(&self) -> DomainCommandKind {
        match self {
            ...
            Self::SessionBegin => DomainCommandKind::SessionBegin,
            Self::SessionTerminalDisposition => DomainCommandKind::SessionTerminalDisposition,
            ...
            Self::SessionArchive => DomainCommandKind::SessionArchive,
            Self::SessionArchivePurge => DomainCommandKind::SessionArchivePurge,
