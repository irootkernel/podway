...
fn required_result_fields_v2(schema: &str) -> &'static [&'static str] {
    match schema {
        ...
        // V2SCL-005 made the missing-identifier array a window, because 128 items per definition
        // can produce more identifiers than its 64-entry ceiling holds. Only v3 gains the fields;
        // a released family never grows a required member.
        "podway.status-result/v3" => &[
            "schema",
            "tier",
            "procedure",
            ...
            "missing_required_item_ids_truncated",
            "blocker_window",
            "blockers_truncated",
            "item_values",
            "items_total",
