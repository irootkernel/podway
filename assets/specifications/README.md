...
- `sqlite-v10.sql`: live workspace runtime-mode binding migration; legacy stores migrate as production and named-mode mismatches fail before normal Store access.
