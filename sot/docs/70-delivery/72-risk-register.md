...
| `R-19` | macOS Intel support delays delivery | medium | medium | unavailable CI or dependency failure | separate target builds, prioritize semantic parity, document release blocker early | Release |
