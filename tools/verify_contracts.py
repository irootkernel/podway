...
V2_RUNTIME_ERROR_CODES = {
    ...
    "GRAPH_NODE_TYPE_MISMATCH", "OPTION_NOT_ALLOWED", "OPTION_GUARD_UNSATISFIED",
    "ROUTE_NOT_ALLOWED",
...
V2_AUTHORING_DIAGNOSTIC_CODES = {
    ...
    "SOURCE_PROJECTION_BUDGET_EXCEEDED", "GRAPH_PROJECTION_BUDGET_EXCEEDED",
    ...
    "DECISION_RECORD_BUDGET_EXCEEDED", "EVIDENCE_PREVIEW_BUDGET_EXCEEDED",
    "PAGE_TOKEN_BUDGET_EXCEEDED", "NEXT_FRAME_BUDGET_EXCEEDED",
    "ATTEMPT_CONTENT_BUDGET_EXCEEDED",
    ...
    "OPTION_LABELS_NOT_DISTINCT", "OPTION_CRITERIA_WEAK",
