...
| `V2RDY-002` | Serve verified status during recovery | Completed | Start the authenticated control plane before registry/worktree/job recovery, expose monotonic readiness progress, and reject normal routes before ready. | [V2RDY dossier](../todo/TODO-podway-phase-aware-daemon-readiness.md) |
