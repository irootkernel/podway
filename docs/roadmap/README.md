...
| `REL12002` | Audit the v1 compatibility boundary | Planned | Prove released-schema compatibility and record the exact pre-release consumer migration boundary. | [V1 compatibility boundary](../todo/TODO-podway-v0.1.2-contract-recovery.md#v1-compatibility-boundary) |
