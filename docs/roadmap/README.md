...
| id | title | status | goal | references |
|---|---|---|---|---|
| `V2MOD-001` | Add v2 domain values | Planned | Represent action, decision, route, rework, and goal values in core. | [V2MOD plan](../todo/TODO-podway-v2-full-feature-ga.md#192-epic-v2mod-procedure-model-and-configuration) |
...
| `V2MOD-006` | Validate v2 semantics | Planned | Reject invalid identities, references, routes, selectors, goal mappings, and bounds. | [V2MOD plan](../todo/TODO-podway-v2-full-feature-ga.md#192-epic-v2mod-procedure-model-and-configuration) |
