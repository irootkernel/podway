...
v0.1.0 [automation contract](../specs/interfaces/automation-client-contract.md)
...
[system](system.md),
[daemon and queue](daemon-and-write-queue.md),
[worktree boundary](git-worktree-and-filesystem.md),
[macOS service](macos-service.md), and
[storage transactions](../specs/storage/transactions-concurrency-and-idempotency.md).
