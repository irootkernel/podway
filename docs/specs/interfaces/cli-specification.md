...
`procedure validate`, `procedure show`, `procedure format`, `procedure lint`, and `procedure check` use the same Rust schema and canonicalization library as the daemon.
