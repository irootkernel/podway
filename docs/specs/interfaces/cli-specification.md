...
`procedure validate`, `procedure show`, `procedure format`, `procedure lint`, `procedure check`, `procedure scaffold`, and `procedure convert` use the same Rust schema and canonicalization library as the daemon.
