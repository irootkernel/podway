...
`procedure validate`, `procedure show`, `procedure format`, `procedure lint`, `procedure check`, and `procedure scaffold` use the same Rust schema and canonicalization library as the daemon.
