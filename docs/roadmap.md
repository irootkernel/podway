...
| `CONID002` | Add machine-readable version identity | Completed | Expose the compact JSON version summary and the opt-in build, target, protocol, and contract identity. | [AUT-CONTRACT-002](reference/interfaces/34-automation-client-contract.md#13-cli-and-daemon-contract-identity-aut-contract-001005) |
...
| `REL10004` | Produce the Dolgorae compatibility handoff | Completed | Publish the binary, contract, source, tree, and toolchain identities required for pinning. | [AUT-REL-002–004](reference/interfaces/34-automation-client-contract.md#23-release-artifact-and-installation-aut-rel-001004) |
